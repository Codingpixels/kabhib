			...
			<div class='subinner'>
				<form>
					<button formaction="<?php echo $this->Html->url(array('controller' => 'Reports', 
							'action' => 'fresh_overall_piechart','today')); ?>" class="current">Today
					</button>
					<button formaction="<?php echo $this->Html->url(array('controller' => 'Reports',
							'action' => 'fresh_overall_piechart','weekly')); ?>" class="current">Weekly
					</button>
					<button formaction="<?php echo $this->Html->url(array('controller' => 'Reports', 
							'action' => 'fresh_overall_piechart','monthly')); ?>" class="current">Monthly
					</button>
					<button formaction="<?php echo $this->Html->url(array('controller' => 'Reports', 
							'action' => 'fresh_overall_piechart','yearly')); ?>" class="current">Yearly
					</button>
				</form>
